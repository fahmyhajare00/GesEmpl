  ...
  return (
    <div className="p-5">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-slate-50">Modules</h1>
      ...
      <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-[0_8px_20px_rgba(0,0,0,0.06)] border border-slate-200 dark:bg-slate-800 dark:border-slate-700">
        <thead className="bg-gradient-to-br from-brand to-brand-hover text-white">
          <tr>
            <th className="p-3.5 text-left text-sm font-bold tracking-wide">Nom du module</th>
          </tr>
        </thead>
        <tbody>
          <tr className="transition-all cursor-pointer hover:bg-slate-50 hover:scale-[1.01] dark:hover:bg-slate-700/50">
            <td className="p-3.5 text-[0.95rem] text-slate-600 border-b border-slate-100 dark:text-slate-300 dark:border-slate-700">React Avancé</td>
          </tr>
          <tr className="transition-all cursor-pointer hover:bg-slate-50 hover:scale-[1.01] dark:hover:bg-slate-700/50">
            <td className="p-3.5 text-[0.95rem] text-slate-600 border-b border-slate-100 dark:text-slate-300 dark:border-slate-700">Laravel</td>
          </tr>
        </tbody>
      </table>
    </div>
