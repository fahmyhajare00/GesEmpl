    ...
    <header className="sticky top-0 z-30 h-[70px] bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-sm dark:bg-slate-900/95 dark:border-slate-800 transition-colors duration-300 flex flex-col justify-center">
      <div className="flex items-center justify-between h-16 px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {/* Profil : Avatar et nom complet */}
          <div className="flex items-center gap-2.5 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 p-1.5 pr-2 rounded-full transition-colors">
            <div className="hidden sm:flex flex-col items-end">
              <span className="text-[0.8rem] font-bold text-gray-800 dark:text-gray-100 leading-tight">
            ...
            <div className="bg-gradient-to-br from-sky-400 to-blue-600 text-white w-9 h-9 rounded-full flex items-center justify-center font-bold text-sm shadow-md border-2 border-white dark:border-gray-800">
              {getInitial()}
            </div>
          </div>
        </div>
